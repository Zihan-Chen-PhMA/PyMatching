...
perhaps a few soft outputs) is calculated based on the internal variables (graph_fill_regions) created during the docoding process. See folder [SO_example](https://github.com/Zihan-Chen-PhMA/PyMatching/tree/master/SO_example) for an 
